...
pub const strings = Strings{
    ...
    .err_only_requires_path = "Błąd: --only wymaga argumentu ścieżki",
    .err_max_lines_requires_number = "Błąd: --max-lines wymaga argumentu liczbowego",
    .err_head_requires_number = "Błąd: --head wymaga argumentu liczbowego",
    .err_tail_requires_number = "Błąd: --tail wymaga argumentu liczbowego",
