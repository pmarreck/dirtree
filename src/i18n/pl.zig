...
pub const strings = Strings{
    ...
    .warn_negation_advice = "Aby skupić się na jednej ścieżce, użyj --only PATH; do filtra pozytywnego --show /PAT/ (reguły show mają priorytet nad hide). Reguły zapisują się w .dirtree-state — pliku tekstowym, który możesz edytować ręcznie, gdy się komplikują lub nakładają.",
