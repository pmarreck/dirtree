...
pub const strings = Strings{
    ...
    .err_only_requires_path = "错误: --only 需要一个路径参数",
    .err_max_lines_requires_number = "错误: --max-lines 需要一个数字参数",
    .err_head_requires_number = "错误: --head 需要一个数字参数",
    .err_tail_requires_number = "错误: --tail 需要一个数字参数",
