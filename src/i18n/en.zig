...
pub const strings = Strings{
    ...
    .help_opt_temp_depth = "  -td, --temp-depth N Set max depth for this run only (not saved)",
    ...
    .err_temp_depth_requires_number = "Error: --temp-depth requires a numeric argument",
...
pub const aliases = LocaleAliases{
    .cli = &[_]CliAliasEntry{
        ...
        .{ .name = "--temp-depth", .arg = .temp_depth },
        .{ .name = "--path", .arg = .path },
