...
pub const strings = Strings{
    ...
    .help_opt_temp_depth = "  -td, --temp-depth N Atur kedalaman maks hanya untuk eksekusi ini (tidak disimpan)",
    ...
    .help_opt_no_color = "  --no-color        Nonaktifkan warna ANSI dan simpan preferensi",
    ...
    .help_opt_no_hyperlinks = "  --no-hyperlinks   Nonaktifkan hyperlink OSC8 dan simpan preferensi",
    ...
    .err_temp_depth_requires_number = "Kesalahan: --temp-depth memerlukan argumen numerik (en: Error: --temp-depth requires a numeric argument)",
...
pub const aliases = LocaleAliases{
    .cli = &[_]CliAliasEntry{
        ...
        .{ .name = "--kedalaman-sementara", .arg = .temp_depth },
        .{ .name = "--jalur", .arg = .path },
