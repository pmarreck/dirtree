...
pub const strings = Strings{
    ...
    .warn_negation_advice = "Para enfocar una ruta, usa --only PATH; para un filtro positivo, --show /PAT/ (las reglas show tienen prioridad sobre hide). Estas reglas se guardan en .dirtree-state, texto plano que puedes editar a mano cuando se vuelven complejas o se solapan.",
