...
pub const strings = Strings{
    ...
    .err_only_requires_path = "Error: --only requiere un argumento de ruta",
    .err_max_lines_requires_number = "Error: --max-lines requiere un argumento num\\xc3\\xa9rico",
    .err_head_requires_number = "Error: --head requiere un argumento num\\xc3\\xa9rico",
    .err_tail_requires_number = "Error: --tail requiere un argumento num\\xc3\\xa9rico",
    .err_notes_requires_mode = "Error: --notes requiere 'aligned' o 'inline'",
    ...
    .err_regex_invalid = "Error: patrón regex no válido: {s}",
