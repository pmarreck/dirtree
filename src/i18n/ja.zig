...
pub const strings = Strings{
    ...
    .err_head_requires_number = "エラー: --head には数値引数が必要です (en: Error: --head requires a numeric argument)",
    .err_tail_requires_number = "エラー: --tail には数値引数が必要です (en: Error: --tail requires a numeric argument)",
