...
pub const strings = Strings{
    ...
    .help_opt_temp_depth = "  -td, --temp-depth N केवल इस बार के लिए अधिकतम गहराई निर्धारित करें (सहेजा नहीं जाता)",
    ...
    .help_opt_no_color = "  --no-color        ANSI रंग अक्षम करें और प्राथमिकता सहेजें",
    ...
    .help_opt_no_hyperlinks = "  --no-hyperlinks   OSC8 हाइपरलिंक अक्षम करें और प्राथमिकता सहेजें",
    ...
    .err_temp_depth_requires_number = "त्रुटि: --temp-depth को एक संख्यात्मक तर्क चाहिए (en: Error: --temp-depth requires a numeric argument)",
...
pub const aliases = LocaleAliases{
    .cli = &[_]CliAliasEntry{
        ...
        .{ .name = "--asthayi-gehrai", .arg = .temp_depth },
        .{ .name = "--path", .arg = .path },
