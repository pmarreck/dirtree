...
pub const strings = Strings{
    ...
    .err_only_requires_path = "שגיאה: --only דורש ארגומנט נתיב",
    .err_max_lines_requires_number = "שגיאה: --max-lines דורש ארגומנט מספרי",
    .err_head_requires_number = "שגיאה: --head דורש ארגומנט מספרי",
    .err_tail_requires_number = "שגיאה: --tail דורש ארגומנט מספרי",
    .err_notes_requires_mode = "שגיאה: --notes דורש 'aligned' או 'inline'",
