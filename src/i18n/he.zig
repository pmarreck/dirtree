...
pub const strings = Strings{
    ...
    .help_opt_head = "  --head N           עצירת הפלט אחרי N שורות",
    .help_opt_tail = "  --tail N           הצגת N השורות האחרונות בלבד (עדיף לצנרת אל tail -N)",
    ...
    .warn_large_output_suffix = "). שקול: --depth N, --head N או תבניות --hide.",
    .warn_truncated_head_prefix = "(הפלט נקטע אחרי ",
    .warn_truncated_head_suffix = " שורות על ידי --head)",
    ...
    .err_head_requires_number = "שגיאה: --head דורש ארגומנט מספרי (en: Error: --head requires a numeric argument)",
    .err_tail_requires_number = "שגיאה: --tail דורש ארגומנט מספרי (en: Error: --tail requires a numeric argument)",
