...
pub const strings = Strings{
    ...
    .warn_negation_advice = "للتركيز على مسار واحد استخدم --only PATH؛ ولمرشّح إيجابي استخدم --show /PAT/ (قواعد show لها أولوية على hide). تُحفظ هذه القواعد في .dirtree-state، وهو ملف نصي يمكنك تحريره يدويًا عندما تتعقّد أو تتداخل.",
