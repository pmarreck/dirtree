...
pub const strings = Strings{
    ...
    .err_head_requires_number = "خطأ: --head يتطلب معاملاً رقمياً (en: Error: --head requires a numeric argument)",
    .err_tail_requires_number = "خطأ: --tail يتطلب معاملاً رقمياً (en: Error: --tail requires a numeric argument)",
