...
pub const strings = Strings{
    ...
    .err_only_requires_path = "Помилка: --only потребує аргумент-шлях",
    .err_max_lines_requires_number = "Помилка: --max-lines потребує числовий аргумент",
    .err_head_requires_number = "Помилка: --head потребує числовий аргумент",
    .err_tail_requires_number = "Помилка: --tail потребує числовий аргумент",
    .err_notes_requires_mode = "Помилка: --notes потребує 'aligned' або 'inline'",
