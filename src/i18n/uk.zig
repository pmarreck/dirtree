...
pub const strings = Strings{
    ...
    .help_opt_head = "  --head N           Зупинити вивід після N рядків",
    .help_opt_tail = "  --tail N           Показати лише останні N рядків (краще передати в tail -N)",
    ...
    .warn_large_output_suffix = "). Розгляньте: --depth N, --head N або шаблони --hide.",
    .warn_truncated_head_prefix = "(Вивід обрізано після ",
    .warn_truncated_head_suffix = " рядків через --head)",
    ...
    .err_head_requires_number = "Помилка: --head потребує числовий аргумент (en: Error: --head requires a numeric argument)",
    .err_tail_requires_number = "Помилка: --tail потребує числовий аргумент (en: Error: --tail requires a numeric argument)",
