...
pub const strings = Strings{
    ...
    .err_temp_depth_requires_number = "Errore: --temp-depth richiede un argomento numerico",
    .err_path_requires_arg = "Errore: --path richiede un argomento di directory",
    ...
    .err_only_requires_path = "Errore: --only richiede un argomento di percorso",
    .err_max_lines_requires_number = "Errore: --max-lines richiede un argomento numerico",
    .err_head_requires_number = "Errore: --head richiede un argomento numerico",
    .err_tail_requires_number = "Errore: --tail richiede un argomento numerico",
    .err_notes_requires_mode = "Errore: --notes richiede 'aligned' o 'inline'",
