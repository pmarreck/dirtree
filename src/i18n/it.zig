...
pub const strings = Strings{
    ...
    .warn_negation_advice = "Per concentrarti su un percorso usa --only PATH; per un filtro positivo --show /PAT/ (le regole show hanno priorità su hide). Queste regole si salvano in .dirtree-state, testo semplice modificabile a mano quando diventano complesse o si sovrappongono.",
