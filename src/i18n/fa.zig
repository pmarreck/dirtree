...
pub const strings = Strings{
    ...
    .help_opt_head = "  --head N           توقف خروجی پس از N خط",
    .help_opt_tail = "  --tail N           نمایش فقط N خط آخر (ترجیحاً به tail -N لوله کنید)",
    ...
    .warn_large_output_suffix = "). در نظر بگیرید: --depth N، --head N یا الگوهای --hide.",
    .warn_truncated_head_prefix = "(خروجی پس از ",
    .warn_truncated_head_suffix = " خط توسط --head کوتاه شد)",
    .err_only_requires_path = "خطا: --only به یک آرگومان مسیر نیاز دارد",
    .err_max_lines_requires_number = "خطا: --max-lines به یک آرگومان عددی نیاز دارد",
    .err_head_requires_number = "خطا: --head به یک آرگومان عددی نیاز دارد",
    .err_tail_requires_number = "خطا: --tail به یک آرگومان عددی نیاز دارد",
    .err_notes_requires_mode = "خطا: --notes به 'aligned' یا 'inline' نیاز دارد",
