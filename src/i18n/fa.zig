...
pub const strings = Strings{
    ...
    .err_head_requires_number = "خطا: --head به یک آرگومان عددی نیاز دارد (en: Error: --head requires a numeric argument)",
    .err_tail_requires_number = "خطا: --tail به یک آرگومان عددی نیاز دارد (en: Error: --tail requires a numeric argument)",
