...
pub const strings = Strings{
    ...
    .help_opt_head = "  --head N           Çıxışı N sətirdən sonra dayandır",
    .help_opt_tail = "  --tail N           Yalnız son N sətiri göstər (tail -N-ə yönləndirmək tövsiyə olunur)",
    ...
    .warn_large_output_suffix = "). Nəzərdən keçirin: --depth N, --head N və ya --hide şablonları.",
    .warn_truncated_head_prefix = "(Çıxış ",
    .warn_truncated_head_suffix = " sətirdən sonra --head ilə kəsildi)",
    ...
    .err_head_requires_number = "X\\xc9\\x99ta: --head r\\xc9\\x99q\\xc9\\x99mli arqument t\\xc9\\x99l\\xc9\\x99b edir (en: Error: --head requires a numeric argument)",
    .err_tail_requires_number = "X\\xc9\\x99ta: --tail r\\xc9\\x99q\\xc9\\x99mli arqument t\\xc9\\x99l\\xc9\\x99b edir (en: Error: --tail requires a numeric argument)",
