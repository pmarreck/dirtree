...
pub const strings = Strings{
    ...
    .warn_negation_advice = "Bir yola fokuslanmaq üçün --only PATH; müsbət filtr üçün --show /PAT/ istifadə edin (show qaydaları hide-dan üstündür). Bu qaydalar .dirtree-state-də saxlanılır — mürəkkəbləşəndə və ya üst-üstə düşəndə əl ilə redaktə edilə bilən mətn faylı.",
