...
pub const strings = Strings{
    ...
    .err_head_requires_number = "오류: --head에는 숫자 인수가 필요합니다 (en: Error: --head requires a numeric argument)",
    .err_tail_requires_number = "오류: --tail에는 숫자 인수가 필요합니다 (en: Error: --tail requires a numeric argument)",
