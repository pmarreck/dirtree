...
pub const strings = Strings{
    ...
    .err_only_requires_path = "Erreur : --only nécessite un argument de chemin",
    .err_max_lines_requires_number = "Erreur : --max-lines n\\xc3\\xa9cessite un argument num\\xc3\\xa9rique",
    .err_head_requires_number = "Erreur : --head n\\xc3\\xa9cessite un argument num\\xc3\\xa9rique",
    .err_tail_requires_number = "Erreur : --tail n\\xc3\\xa9cessite un argument num\\xc3\\xa9rique",
    .err_notes_requires_mode = "Erreur : --notes nécessite 'aligned' ou 'inline'",
