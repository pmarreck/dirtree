...
pub const strings = Strings{
    ...
    .warn_negation_advice = "Pour cibler un chemin, utilisez --only PATH ; pour un filtre positif, --show /PAT/ (les règles show priment sur hide). Ces règles sont enregistrées dans .dirtree-state, un fichier texte modifiable à la main quand elles deviennent complexes ou se chevauchent.",
