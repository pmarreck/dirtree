...
pub const strings = Strings{
    ...
    .warn_negation_advice = "Um einen Pfad zu fokussieren, nutze --only PATH; für einen positiven Filter --show /PAT/ (Show-Regeln haben Vorrang vor Hide). Diese Regeln werden in .dirtree-state gespeichert — eine Textdatei, die du bei komplexen oder überlappenden Regeln von Hand bearbeiten kannst.",
