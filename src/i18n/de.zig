...
pub const strings = Strings{
    ...
    .err_only_requires_path = "Fehler: --only erfordert ein Pfadargument",
    .err_max_lines_requires_number = "Fehler: --max-lines erfordert ein numerisches Argument",
    .err_head_requires_number = "Fehler: --head erfordert ein numerisches Argument",
    .err_tail_requires_number = "Fehler: --tail erfordert ein numerisches Argument",
    .err_notes_requires_mode = "Fehler: --notes erfordert 'aligned' oder 'inline'",
