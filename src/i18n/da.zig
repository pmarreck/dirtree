...
pub const strings = Strings{
    ...
    .help_opt_temp_depth = "  -td, --temp-depth N Angiv maksimal dybde kun for denne kørsel (gemmes ikke)",
    ...
    .help_opt_no_color = "  --no-color        Deaktivér ANSI-farver og gem indstillingen",
    ...
    .help_opt_no_hyperlinks = "  --no-hyperlinks   Deaktivér OSC8-hyperlinks og gem indstillingen",
    ...
    .err_temp_depth_requires_number = "Fejl: --temp-depth kræver et numerisk argument (en: Error: --temp-depth requires a numeric argument)",
...
pub const aliases = LocaleAliases{
    .cli = &[_]CliAliasEntry{
        ...
        .{ .name = "--temp-dybde", .arg = .temp_depth },
        .{ .name = "--sti", .arg = .path },
