...
pub const strings = Strings{
    ...
    .warn_negation_advice = "Tek bir yola odaklanmak için --only PATH; olumlu filtre için --show /PAT/ kullanın (show kuralları hide'a göre önceliklidir). Bu kurallar .dirtree-state içine kaydedilir; karmaşıklaştığında veya çakıştığında elle düzenleyebileceğiniz düz metindir.",
