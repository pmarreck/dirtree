...
pub const strings = Strings{
    ...
    .help_opt_head = "  --head N           Çıktıyı N satırdan sonra durdur",
    .help_opt_tail = "  --tail N           Yalnızca son N satırı göster (tercihen tail -N'e yönlendirin)",
    ...
    .warn_large_output_suffix = "). Şunları düşünün: --depth N, --head N veya --hide desenleri.",
    .warn_truncated_head_prefix = "(Çıktı ",
    .warn_truncated_head_suffix = " satırdan sonra --head ile kısaltıldı)",
    ...
    .err_head_requires_number = "Hata: --head say\\xc4\\xb1sal bir arg\\xc3\\xbcman gerektirir (en: Error: --head requires a numeric argument)",
    .err_tail_requires_number = "Hata: --tail say\\xc4\\xb1sal bir arg\\xc3\\xbcman gerektirir (en: Error: --tail requires a numeric argument)",
