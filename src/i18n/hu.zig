...
pub const strings = Strings{
    ...
    .err_default_visibility_conflict = "Hiba: --default l\xc3\xa1that\xc3\xb3s\xc3\xa1gi \xc3\xbctk\xc3\xb6z\xc3\xa9s",
    .err_default_accepts = "Hiba: --default elfogadja: opened/closed/shown/hidden",
