...
pub const strings = Strings{
    ...
    .warn_negation_advice = "Egy útvonalra fókuszáláshoz használd a --only PATH-t; pozitív szűrőhöz a --show /PAT/-t (a show szabályok elsőbbséget élveznek a hide-dal szemben). A szabályok a .dirtree-state-be mentődnek — ez sima szöveg, amit kézzel szerkeszthetsz, ha bonyolulttá válnak vagy átfedik egymást.",
