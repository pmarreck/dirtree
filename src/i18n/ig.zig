...
pub const strings = Strings{
    ...
    .help_opt_temp_depth = "  -td, --temp-depth N Tọọ omimi kachasị naanị maka ọsọ a (echekwaghị)",
    ...
    .help_opt_no_color = "  --no-color        Gbanyụọ agba ANSI ma chekwaa mmasị",
    ...
    .help_opt_no_hyperlinks = "  --no-hyperlinks   Gbanyụọ njikọ OSC8 ma chekwaa mmasị",
    ...
    .err_temp_depth_requires_number = "Njehie: --temp-depth chọrọ arụmụka ọnụọgụgụ (en: Error: --temp-depth requires a numeric argument)",
...
pub const aliases = LocaleAliases{
    .cli = &[_]CliAliasEntry{
        ...
        .{ .name = "--omimi-nwa-oge", .arg = .temp_depth },
        .{ .name = "--uzo", .arg = .path },
