...
pub const strings = Strings{
    ...
    .warn_negation_advice = "Para focar em um caminho, use --only PATH; para um filtro positivo, --show /PAT/ (regras show têm prioridade sobre hide). Essas regras são salvas em .dirtree-state, texto puro que você pode editar à mão quando ficam complexas ou se sobrepõem.",
