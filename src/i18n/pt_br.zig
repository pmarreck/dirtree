...
pub const strings = Strings{
    ...
    .err_temp_depth_requires_number = "Erro: --temp-depth requer um argumento num\xc3\xa9rico (en: Error: --temp-depth requires a numeric argument)",
    ...
    .err_head_requires_number = "Erro: --head requer um argumento num\\xc3\\xa9rico (en: Error: --head requires a numeric argument)",
    .err_tail_requires_number = "Erro: --tail requer um argumento num\\xc3\\xa9rico (en: Error: --tail requires a numeric argument)",
