...
pub const strings = Strings{
    ...
    .help_opt_head = "  --head N           Parar a saída após N linhas",
    .help_opt_tail = "  --tail N           Mostrar apenas as últimas N linhas (prefira canalizar para tail -N)",
    ...
    .warn_large_output_suffix = "). Considere: --depth N, --head N, ou padrões --hide.",
    .warn_truncated_head_prefix = "(Saída truncada após ",
    .warn_truncated_head_suffix = " linhas por --head)",
    .err_only_requires_path = "Erro: --only requer um argumento de caminho",
    .err_max_lines_requires_number = "Erro: --max-lines requer um argumento num\\xc3\\xa9rico",
    .err_head_requires_number = "Erro: --head requer um argumento num\\xc3\\xa9rico",
    .err_tail_requires_number = "Erro: --tail requer um argumento num\\xc3\\xa9rico",
    .err_notes_requires_mode = "Erro: --notes requer 'aligned' ou 'inline'",
