...
pub const strings = Strings{
    ...
    .help_opt_temp_depth = "  -td, --temp-depth N یوازې د دې ځل لپاره اعظمي ژوروالی وټاکه (نه ساتل کیږي)",
    ...
    .help_opt_no_color = "  --no-color        د ANSI رنګونه غیر فعال کړه او غوراوی وساته",
    ...
    .help_opt_no_hyperlinks = "  --no-hyperlinks   د OSC8 هایپرلینکونه غیر فعال کړه او غوراوی وساته",
    ...
    .err_temp_depth_requires_number = "تېروتنه: --temp-depth یوه شمیریزه دلیل ته اړتیا لري (en: Error: --temp-depth requires a numeric argument)",
...
pub const aliases = LocaleAliases{
    .cli = &[_]CliAliasEntry{
        ...
        .{ .name = "--lanrmhala-jarwaaley", .arg = .temp_depth },
        .{ .name = "--laar", .arg = .path },
