...
pub const strings = Strings{
    ...
    .warn_negation_advice = "Pentru a te concentra pe o cale folosește --only PATH; pentru un filtru pozitiv --show /PAT/ (regulile show au prioritate față de hide). Aceste reguli se salvează în .dirtree-state, text simplu pe care îl poți edita manual când devin complexe sau se suprapun.",
