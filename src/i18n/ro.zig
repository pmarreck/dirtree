...
pub const strings = Strings{
    ...
    .err_only_requires_path = "Eroare: --only necesită un argument de cale",
    .err_max_lines_requires_number = "Eroare: --max-lines necesit\\xc4\\x83 un argument numeric",
    .err_head_requires_number = "Eroare: --head necesit\\xc4\\x83 un argument numeric",
    .err_tail_requires_number = "Eroare: --tail necesit\\xc4\\x83 un argument numeric",
    .err_notes_requires_mode = "Eroare: --notes necesită 'aligned' sau 'inline'",
