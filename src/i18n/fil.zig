...
pub const strings = Strings{
    ...
    .help_opt_temp_depth = "  -td, --temp-depth N Itakda ang max na lalim para sa takbong ito lamang (hindi sine-save)",
    ...
    .help_opt_no_color = "  --no-color        Huwag paganahin ang mga ANSI color at i-save ang kagustuhan",
    ...
    .help_opt_no_hyperlinks = "  --no-hyperlinks   Huwag paganahin ang mga OSC8 hyperlink at i-save ang kagustuhan",
    ...
    .err_temp_depth_requires_number = "Error: ang --temp-depth ay nangangailangan ng numerong argumento (en: Error: --temp-depth requires a numeric argument)",
...
pub const aliases = LocaleAliases{
    .cli = &[_]CliAliasEntry{
        ...
        .{ .name = "--pansamantalang-lalim", .arg = .temp_depth },
