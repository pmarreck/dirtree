...
pub const Strings = struct {
    ...
    orphaned_header: [:0]const u8 = "Orphaned notes (paths that no longer exist):",
    orphaned_none: [:0]const u8 = "No orphaned notes.",
    purge_header: [:0]const u8 = "Purged orphaned notes:",
    purge_none: [:0]const u8 = "No orphaned notes to purge.",
