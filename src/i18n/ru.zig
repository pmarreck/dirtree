...
pub const strings = Strings{
    ...
    .err_only_requires_path = "Ошибка: --only требует аргумент-путь",
    .err_max_lines_requires_number = "Ошибка: --max-lines требует числовой аргумент",
    .err_head_requires_number = "Ошибка: --head требует числовой аргумент",
    .err_tail_requires_number = "Ошибка: --tail требует числовой аргумент",
    .err_notes_requires_mode = "Ошибка: --notes требует 'aligned' или 'inline'",
